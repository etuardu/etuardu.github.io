...
output += "\n\n";
var t_6;
t_6 = env.getFilter("getPreviousCollectionItem").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "collections")),runtime.contextOrFrameLookup(context, frame, "currentCollection")),runtime.contextOrFrameLookup(context, frame, "page"));
frame.set("previousPost", t_6, true);
if(frame.topLevel) {
context.setVariable("previousPost", t_6);
}
if(frame.topLevel) {
context.addExport("previousPost", t_6);
}
var t_7;
t_7 = env.getFilter("getNextCollectionItem").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "collections")),runtime.contextOrFrameLookup(context, frame, "currentCollection")),runtime.contextOrFrameLookup(context, frame, "page"));
frame.set("nextPost", t_7, true);
if(frame.topLevel) {
context.setVariable("nextPost", t_7);
}
if(frame.topLevel) {
context.addExport("nextPost", t_7);
}
output += "<p class=\"[ intro__meta ] [ text-500 leading-tight ]\">\n  ";
...
tasks.push(
function(callback) {
env.getTemplate("partials/components/intro.njk", false, "layouts/post.njk", false, function(t_11,t_10) {
if(t_11) { cb(t_11); return; }
callback(null,t_10);});
});
tasks.push(
...
if(!runtime.contextOrFrameLookup(context, frame, "headerless")) {
output += "\n          ";
...
output += "\" alt=\"\" loading=\"lazy\" width=\"900\">\n            </p>\n          ";
;
}
output += "\n          ";
if(runtime.contextOrFrameLookup(context, frame, "excerpt")) {
output += "\n            <blockquote>";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "excerpt"), env.opts.autoescape);
output += "</blockquote>\n            <hr/>\n          ";
;
}
output += "\n        ";
...
output += "\n\n        ";
output += runtime.suppressValue(env.getFilter("safe").call(context, runtime.contextOrFrameLookup(context, frame, "content")), env.opts.autoescape);
output += "\n\n        <address rel=\"author\" style=\"display: flex; align-items: center; font-style: unset;\">\n          <div class=\"round-photo\" style=\"width: 60px; height: 60px;\">\n            <img src=\"/images/edoardo.jpeg\">\n          </div>\n          <div class=\"nav__item\" style=\"padding-left: 1em;\">\n            <a href=\"/about-me\" class=\"color-slate text-base\" style=\"opacity: .9;\">Edoardo Nannotti</a>\n            <p class=\"text-base\" style=\"opacity: .7;\">Welcome! I'm Edoardo Nannotti, a software developer and designer based in Italy <i>[…]</i></p>\n          </div>\n        </address>\n\n      </div>\n\n      ";
...
tasks.push(
function(callback) {
env.getTemplate("partials/global/third-party-comments.njk", false, "layouts/post.njk", false, function(t_15,t_14) {
if(t_15) { cb(t_15); return; }
callback(null,t_14);});
});
tasks.push(
...
output += "\n\n      <ul class=\"[ nav__list ]\" style=\"display:flex; justify-content: space-around; margin-bottom: 40px\">\n        ";
if(runtime.contextOrFrameLookup(context, frame, "previousPost")) {
output += "<li class=\"nav__item\"><a href=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "previousPost")),"url"), env.opts.autoescape);
output += "\">← ";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "previousPost")),"data")),"title"), env.opts.autoescape);
output += "</a></li>";
;
}
output += "\n        ";
if(runtime.contextOrFrameLookup(context, frame, "nextPost")) {
output += "<li class=\"nav__item\"><a href=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "nextPost")),"url"), env.opts.autoescape);
output += "\">";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "nextPost")),"data")),"title"), env.opts.autoescape);
output += " →</a></li>";
;
}
output += "\n      </ul>\n\n      ";
...
frame = frame.push();
var t_20 = runtime.contextOrFrameLookup(context, frame, "tags");
...
output += "\n            <li class=\"post-list__item gap-bottom-300\">\n              <a href=\"";
output += runtime.suppressValue(runtime.memberLookup((t_4),"url"), env.opts.autoescape);
output += "\" rel=\"bookmark\">\n                <img style=\"border-radius: 3px; object-fit: cover; width: 100%; height: 200px;\" class=\"post-card-image\" src=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_4),"data")),"image"), env.opts.autoescape);
output += "\" alt=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "post")),"data")),"title"), env.opts.autoescape);
output += "\">\n              </a>\n              <p class=\"text-100 gap-top-200\">\n                ";
var t_5;
t_5 = (lineno = 12, colno = 37, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "joiner"), "joiner", context, ["·"]));
frame.set("comma", t_5, true);
if(frame.topLevel) {
context.setVariable("comma", t_5);
}
if(frame.topLevel) {
context.addExport("comma", t_5);
}
output += "\n                ";
frame = frame.push();
var t_8 = runtime.memberLookup((runtime.memberLookup((t_4),"data")),"tags");
...
if(t_9 !== "posts") {
output += "\n                    ";
output += runtime.suppressValue((lineno = 15, colno = 28, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "comma"), "comma", context, [])), env.opts.autoescape);
output += "\n                    <a href=\"/tags/";
output += runtime.suppressValue(t_9, env.opts.autoescape);
output += "\" class=\"post-list__link\">";
output += runtime.suppressValue(t_9, env.opts.autoescape);
output += "</a>\n                  ";
;
}
...
frame = frame.pop();
output += "\n              </p>\n              <h3 class=\"font-base leading-tight text-600 weight-mid gap-top-200\">\n                <a href=\"";
output += runtime.suppressValue(runtime.memberLookup((t_4),"url"), env.opts.autoescape);
...
output += "\n              </p>\n              <p class=\"text-200 gap-top-300 weight-mid\">\n                <time datetime=\"";
...
output += "\n      <p class=\"[ site-foot__credit ] [ pad-top-900 ]\">\n        <a href=\"https://creativecommons.org/licenses/by/4.0/\" rel=\"external noreferer noopener\" target=\"_blank\">CC BY 4.0</a> Edoardo Nannotti. Powered <a href=\"https://www.11ty.dev/\" rel=\"external noreferer noopener\" target=\"_blank\">11ty</a> and <a href=\"https://hylia.website\" rel=\"external noopener noreferer\" target=\"_blank\">Hylia</a>.\n      </p>\n    ";
;
}
output += "\n  </div>\n</footer>\n";
if(parentTemplate) {
